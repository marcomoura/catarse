...
(function($) {
	...
	$.fn.carouFredSel = function(options, configs) {
		...
		$cfs._cfs_bind_events = function() {
			...
			$cfs.bind(cf_e('updatePageStatus', conf), function(e, build, sizes) {
				...
				opts.pagination.container.each(function() {
					$(this).children().removeClass(conf.classnames.selected).eq($cfs.triggerHandler(cf_e('currentPage', conf))).addClass(conf.classnames.selected);
				});
				return true;
			});
	...
	function nv_showNavi(o, t, c) {
		...
		if (o.prev.button) o.prev.button[f]()[s](c.classnames.hidden);
		if (o.next.button) o.next.button[f]()[s](c.classnames.hidden);
		if (o.pagination.container) o.pagination.container[f]()[s](c.classnames.hidden);
	}
	function nv_enableNavi(o, f, c) {
		...
		if (o.next.button) {
			...
			o.next.button[fn](c.classnames.disabled);
		}
		if (o.prev.button) {
			var fn = fx || (f == 0) ? 'addClass' : 'removeClass';
			o.prev.button[fn](c.classnames.disabled);
		}
	}
